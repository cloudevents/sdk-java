...
-   [restful-ws-quarkus](restful-ws-quarkus) shows how to use the module
    `cloudevents-http-restful-ws-jakarta` with Quarkus to receive and send CloudEvents
    through HTTP.
-   [restful-ws-spring-boot](restful-ws-spring-boot) shows how to use the module
    `cloudevents-http-restful-ws-jakarta` with Spring Boot and Jersey to receive and
