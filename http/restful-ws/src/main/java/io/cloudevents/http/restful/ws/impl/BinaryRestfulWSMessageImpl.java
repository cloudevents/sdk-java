...
public final class BinaryRestfulWSMessageImpl extends BaseGenericBinaryMessageImpl<String, String> {

    private final MultivaluedMap<String, String> headers;

    public BinaryRestfulWSMessageImpl(SpecVersion version, MultivaluedMap<String, String> headers, byte[] body) {
        super(version, body);
